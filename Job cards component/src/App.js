                ...
                return (
                    <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all">
                        <div className="flex items-center justify-center gap-3">
                            <div className={`h-10 w-10 rounded-lg bg-gradient-to-br ${card.backgroundColors[0]} ${card.backgroundColors[1]} flex items-center justify-center`}>
                                {card.svg}
                            </div>
                            <div className="">{card.position}</div>
                        </div>
                        <button className="py-3 px-6 border border-slate-300 rounded-md text-xs mt-5 block w-full hover:bg-slate-800 hover:text-white hover:border-none">
                            {card.numberOfOpenPositions} open positions
                        </button>
                    </div>
                )
            })}
